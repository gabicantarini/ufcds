...
public class JFrameListarPets extends javax.swing.JFrame {

    /**
     * Creates new form JFrameListarPets
     */
    public JFrameListarPets() {
        initComponents();
        ...
        try {
            ...
            ResultSet resultadoQuery = stat1.executeQuery("Select * From clinicaveterinaria.pets");

            String texto="";
              while( resultadoQuery.next()) 
                   texto= texto + resultadoQuery.getString("IDChip")
                           +"\t"+resultadoQuery.getString("Nome")
                           + "\t"+ resultadoQuery.getString("NIFDono")
                           + "\t"+ resultadoQuery.getString("Especie_Raca")
                           +"\n";
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jTextArea2, javax.swing.GroupLayout.DEFAULT_SIZE, 243, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameListarPets.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameListarPets().setVisible(true);
            }
        });
    }
